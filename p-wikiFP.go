...
// Does the same thing as googleFP but only looks on the first wikipedia page to pop up with the question
func wikifp(url string, answers [4]string, out chan<- [4]int, wg *sync.WaitGroup) {
	defer wg.Done()
	var finalURL string
